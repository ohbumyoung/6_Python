...
# 렌더링 방식에 따라서 <body>가 비어있을 수 있음
# csr 일 때는 bs으로 파싱할 수 없음
...
with sync_playwright() as p:
    ...
    # wait_until
    #   - ="domcontentloaded : HTML을 다 읽고 DOM트리가 만들어진 시점 (자바스크립트 실행 전)
