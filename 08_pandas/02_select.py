...
"""
    바깥 대괄호는 데이터프레임에서 조회(꺼내기)하기 위해서 사용
...
# Pandas : df[(조건1 & 조건2)] / df[]

# 기준데이터 : 마지막 거래일 기록
# 'close'가 50000을 초과하고, 'changeRate'가 0을 초과하는 데이터
...
"""
    SQL                             Pandas
 ORER_BY 컬럼            df.sort_values(컬럼, ascending=T/F)
  LIMIT 개수                      df.head(개수)
...
print("=== 가장 많이 오른 3 개 종목 ===")   # changeRate
...
# Loc 방식은 조건, 선택이 가능
df.loc[df['close'] > 200_000, ['code', 'close', 'volume']].head(3)
print(result)
