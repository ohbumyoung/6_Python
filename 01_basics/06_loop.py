...
print(f"range(1, 6) -> {list(range(1, 6))}")    #시작값을 1로 지정, 끝값을 6으로 지정, 간격:1

# [0, 2, 4, 6, 8] -> 시작: 0 / 간격: 2 / 끝:10
print(f"range(0, 10, 2) -> {list(range(0, 10, 2))}")

# [-5, -4, -3, -2, -1] -> 시작: -5 / 간격: 1 / 끝: -1
...
for i, m in enumerate(members, start=1): # start: 시작번호 지정
    print(f"[{i}] : {m}")
