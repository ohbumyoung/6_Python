...
# 슬라이싱 : 변수[시작:끝:간격]
print(f"슬라이싱 : {message[0:7]} / {message[0:7:1]} / {message[:7]}")
print(f"{message[7:]}")
print(f"{message[::2]}")
print(f"{message[::-1]}")
...
# 특정 문자 개수 찾기 : count(문자)
print(f"1의 개수 : {message.count('l')}")

# 특정 문자의 인덱스 찾기 : find(문자)
print(f"Python의 위치 : {message.find('P')}")
